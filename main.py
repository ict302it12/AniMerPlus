...
from amr.datasets import AniMerPlusPlusDataModule
from amr.models.animerpp import AniMerPlusPlus
from amr.utils.pylogger import get_pylogger
from amr.utils.misc import log_hyperparameters
import signal
...
def main(cfg: DictConfig) -> Optional[float]:
    datamodule = AniMerPlusPlusDataModule(cfg)
    model = AniMerPlusPlus(cfg)
